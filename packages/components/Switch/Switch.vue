...
import { useId } from '@hr-element/hooks'

defineOptions({ name: 'HrSwitch', inheritAttrs: false })
...
<template>
  <div class="hr-switch"
    ...
    <div class="hr-switch__core">
      <div class="hr-switch__core-inner">
        <span v-if="activeText || inactiveText"
              class="hr-switch__core-inner-text">
          {{ checked ? activeText : inactiveText }}
        </span>
      </div>
      <div class="hr-switch__core-action"></div>
    </div>
  </div>
</template>
