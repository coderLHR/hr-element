...
import { useFocusController } from '@hr-element/hooks'
  ...
  <div class="hr-input"
    ...
    <template v-if="type !== 'textarea'">
      <div v-if="$slots.prepend"
           class="hr-input__prepend">
        <slot name="prepend"></slot>
      </div>
      <div class="hr-input__wrapper"
           ref="wrapperRef">
        <span v-if="$slots.prefix"
              class="hr-input__prefix">
          <slot name="prefix"></slot>
        </span>
        <input class="hr-input__inner"
               ref="inputRef"
               :id="inputId"
               ...
               @focus="handleFocus"
               @blur="handleBlur" />
        <span v-if="$slots.suffix || showClear || showPwdArea"
      ...
      <div v-if="$slots.append"
           class="hr-input__append">
        <slot name="append"></slot>
      </div>
    </template>
    <template v-else>
      <textarea class="hr-textarea__wrapper"
                ref="textareaRef"
                :id="inputId"
                :disabled="isDisabled"
                :readonly="readonly"
