...
describe("Popconfirm/index.ts", () => {
  ...
  it("should be exported with withInstall()", () => {
    expect(HrPopconfirm.install).toBeDefined();
  });

  // 测试 Popconfirm 组件是否被正确导出
  it("should be exported Popconfirm component", () => {
    expect(HrPopconfirm).toBe(PopConfirm);
  });
  ...
  test("should enhance Popconfirm component", () => {
    ...
    expect(enhancedPopconfirm).toBe(HrPopconfirm);
...
describe("Popconfirm.vue", () => {
  ...
  test("popconfirm emits", async () => {
    ...
    expect(wrapper.find(".hr-popconfirm").exists()).toBeTruthy();
    const confirmBtn = wrapper.find(".hr-popconfirm__confirm");
    expect(confirmBtn.exists()).toBeTruthy()

    confirmBtn.trigger("click");
    await vi.runAllTimers();
    expect(wrapper.find(".hr-popconfirm").exists()).toBeFalsy();
    ...
    const cancelBtn = wrapper.find(".hr-popconfirm__cancel");
