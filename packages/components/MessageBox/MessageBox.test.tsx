...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".hr-message-box__header");
    const title = document.querySelector(".hr-message-box__title");
    const message = document.querySelector(".hr-message-box__message");
