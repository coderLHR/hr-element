...
（项目文档地址：https://coderLHR.github.io/hr-element/components/button.html ）
...
describe("Button.vue", () => {
  ...
  test("basic button", async () => {
    ...
    // class
    expect(wrapper.classes()).toContain("hr-button--primary");
...
describe("ButtonGroup.vue", () => {
  test("basic button group", async () => {
    ...
    expect(wrapper.classes()).toContain("hr-button-group");
  });
  ...
  test("button group size", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(`hr-button--${size}`);
    });
  });
  ...
  test("button group type", () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button);
      expect(buttonWrapper.classes()).toContain(`hr-button--${type}`);
    });
  });
